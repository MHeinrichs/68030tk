...
CLK_CNT_P_0_ = NODE,*,6,-;
SM_AMIGA_6_ = NODE,*,5,-;
inst_CLK_000_D5 = NODE,*,4,-;
inst_CLK_000_D6 = NODE,*,7,-;
SM_AMIGA_7_ = NODE,*,5,-;
inst_CLK_OUT_PRE = NODE,*,2,-;
SM_AMIGA_0_ = NODE,*,5,-;
RN_AS_030 = NODE,-1,7,-;
cpu_est_2_ = NODE,*,6,-;
SM_AMIGA_3_ = NODE,*,2,-;
...
CLK_CNT_N_0_ = NODE,*,2,-;
SM_AMIGA_5_ = NODE,*,0,-;
inst_VPA_SYNC = NODE,*,2,-;
inst_DTACK_SYNC = NODE,*,2,-;
CLK_CNT_P_1_ = NODE,*,4,-;
inst_CLK_000_D2 = NODE,*,0,-;
RN_LDS_000 = NODE,-1,3,-;
