...
RN_RESET = NODE,-1,1,-;
inst_nEXP_SPACE_D0reg = NODE,*,5,-;
inst_CLK_000_NE = NODE,*,5,-;
inst_CLK_000_PE = NODE,*,2,-;
...
RN_BG_000 = NODE,-1,3,-;
CIIN_0 = NODE,*,4,-;
pos_clk_un29_clk_000_ne_d0_i_n = NODE,*,3,-;
CYCLE_DMA_0_ = NODE,*,0,-;
inst_AMIGA_BUS_ENABLE_DMA_LOW = NODE,*,2,-;
CLK_000_N_SYNC_10_ = NODE,*,7,-;
CLK_000_N_SYNC_9_ = NODE,*,5,-;
CLK_000_N_SYNC_8_ = NODE,*,6,-;
CLK_000_N_SYNC_7_ = NODE,*,1,-;
CLK_000_N_SYNC_6_ = NODE,*,0,-;
CLK_000_N_SYNC_5_ = NODE,*,1,-;
CLK_000_N_SYNC_4_ = NODE,*,1,-;
CLK_000_N_SYNC_3_ = NODE,*,1,-;
CLK_000_N_SYNC_2_ = NODE,*,6,-;
CLK_000_N_SYNC_1_ = NODE,*,6,-;
CLK_000_N_SYNC_0_ = NODE,*,5,-;
CLK_000_P_SYNC_8_ = NODE,*,0,-;
CLK_000_P_SYNC_7_ = NODE,*,0,-;
CLK_000_P_SYNC_6_ = NODE,*,0,-;
CLK_000_P_SYNC_5_ = NODE,*,5,-;
CLK_000_P_SYNC_4_ = NODE,*,3,-;
CLK_000_P_SYNC_3_ = NODE,*,2,-;
CLK_000_P_SYNC_2_ = NODE,*,1,-;
CLK_000_P_SYNC_1_ = NODE,*,2,-;
