...
cpu_est_0_ = NODE,*,5,-;
SM_AMIGA_1_ = NODE,*,5,-;
inst_CLK_OUT_PRE_D = NODE,*,2,-;
inst_CLK_000_NE = NODE,*,0,-;
inst_CLK_OUT_PRE_50 = NODE,*,4,-;
cpu_est_2_ = NODE,*,6,-;
inst_DS_000_ENABLE = NODE,*,1,-;
inst_CLK_OUT_PRE_25 = NODE,*,2,-;
RN_VMA = NODE,-1,3,-;
